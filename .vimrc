...
"        call setline(1,"<head><meta charset=\"UTF-8\"></head>")
	...
	if expand("%:e") == 'cpp'
        ...
        call append(line(".")+11, "#include<deque>")
        ...
        call append(line(".")+16, "#include<map>")
        call append(line(".")+17, "#include<stack>")
        call append(line(".")+18, "#include<set>")
		call append(line(".")+19, "using namespace std;")
		call append(line(".")+20, "#define ll long long")
        call append(line(".")+21, "#define pb push_back")
        call append(line(".")+22, "#define pi 3.14159265")
        call append(line(".")+23, "#define e 2.71828182")
        call append(line(".")+24, "#define fo(x1,x2,x3,x4) for(int x1=x2;x1<=x3;x1+=x4)")
        call append(line(".")+25, "")
	endif
	if &filetype == 'c'
